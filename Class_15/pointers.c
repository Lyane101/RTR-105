...
int main()
{
  ...
  //*i_pointer = (*i_pointer)++; // inkrements šeit nestrādā, jo, pirmkārt,
                                 // tam ir zemākā prioritāte, otrkārt, izgūta
                                 // vērtība iekš () vairs nav saistīta ne ar
                                 // kādu mainīgo, kuram šī inkrementa
                                 // operācija tiktu veikta
  *i_pointer = (*i_pointer)+1;
  printf("i_value (found by identificator; after increment) = %d\n",i_value);
